...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/09/2024 às 21:30
...
(1, 'jobstage@gmail.com', '9b02906129c8840ced91ac5f934bde4d');
...
INSERT INTO `aluno` (`ID`, `nome`, `email`, `data_nasc`, `telefone`, `estado_civil`, `cidade`, `estado`, `CEP`, `rua`, `numero`, `descricao`, `linkedin`, `termos_de_uso`, `cadastro_completo`, `senha`) VALUES
(31, 'dada', '1', '1111-01-01', '132', 'Solteiro(a)', '79', '1', '45', '46', 456, '', '', 0, 1, 'c4ca4238a0b923820dcc509a6f75849b');
...
CREATE TABLE `assinatura` (
  ...
  `idContratosEstagio` int(11) NOT NULL,
...
INSERT INTO `candidatura` (`ID`, `id_vaga`, `id_aluno`, `id_empresa`) VALUES
(5, 5, 31, 4);
...
INSERT INTO `contratacoes` (`ID`, `idVaga`, `idAluno`, `idEmpresa`, `idContrato`, `idRelatorio`, `contratoGerado`, `contratoAssinado`, `contratoAtivo`) VALUES
(1, 31, 5, 4, 0, 0, 0, 0, 0);
...
CREATE TABLE `contratosestagio` (
  ...
  `idContratacoes` int(11) NOT NULL,
  `assinatura` int(11) NOT NULL DEFAULT 0 COMMENT 'quando existir 3 assinaturas mudar para 1'
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `empresa` (`id_empresa`, `nome`, `cnpj`, `email`, `senha`, `contato`, `estado`, `cidade`, `cep`, `rua`, `numero`) VALUES
(4, 'PPPPPPPP', 'PPPPPP', '1', 'c4ca4238a0b923820dcc509a6f75849b', 'PPPPPP', '2', '101', '789', '789', 7);
...
INSERT INTO `experiencia` (`id_exp`, `nome`, `cargo`, `inicio`, `fim`, `tipo`, `atividades`, `id_aluno`) VALUES
(8, 'Empresa Teste', 'Desenvolvedor', '2022-01-01', '2023-01-01', 'Full-time', 'Desenvolvimento de software', 1);
...
INSERT INTO `filial` (`id_filial`, `nome`, `nivel`, `cursosTecnico`, `cursosSuperior`, `cadastroCompleto`, `id_instituicao`, `estado`, `cidade`, `CEP`, `rua`) VALUES
(19, 'a', '1', NULL, NULL, 0, 28, 0, 0, '', ''),
(20, 'dsfsdf', '2', NULL, NULL, 0, 29, 0, 0, '', '');
...
INSERT INTO `formacao` (`id_formacao`, `curso`, `setor`, `instituicao`, `nivel`, `inicio`, `fim`, `status`, `matricula`, `matricula_valida`, `id_aluno`) VALUES
(4, '218', '', '789', '1', '2003-01-01', '2003-12-14', '456', '671d1d42bb53a7c4d42d90077e78f4b1.pdf', 0, 31);
...
INSERT INTO `vagas` (`idVaga`, `nome`, `salario`, `nivel`, `setor`, `cursos`, `modelo`, `descricao`, `requisitos`, `ativo`, `id_empresa`) VALUES
(5, 'AAAAAAAAAAA', '789', '1', NULL, '218', '1', '789', '789', 1, 4);
