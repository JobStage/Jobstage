...
<div class="card" style="max-height: 700px; overflow:auto;">
    <?= $msg->listarMsg($_SESSION['id'], $_GET['id']) ?>
</div>
...
<div class="input-group mb-3">
    ...
    <button class="btn btn-outline-secondary" type="button" id="button-addon2" onclick="msgEmpresa(<?= $_SESSION['id'] . ',' . $_GET['id'] ?>)">Enviar</button>
</div>
